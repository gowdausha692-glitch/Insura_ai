...
.masthead .name {{ font-family:'Fraunces',Georgia,serif; font-size:44px; font-weight:600;
  color:{T['ink']}; line-height:1.02; letter-spacing:-1px; }}
.masthead .tag {{ color:{T['muted']}; font-size:16px; margin-top:6px; max-width:60ch; }}
